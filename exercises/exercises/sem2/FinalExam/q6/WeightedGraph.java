...
class WeightedGraph<T extends Comparable<T>, N extends Comparable <N>> {
   ...
   public boolean addEdge(T source, T destination, N w, N c)   {
      if (head==null)
         return false;
         ...
         if ( sourceVertex.vertexInfo.compareTo( source ) == 0 )   {
            ...
            while (destinationVertex!=null)	{
               if ( destinationVertex.vertexInfo.compareTo( destination ) == 0 )   {
                  ...
                  Edge<T,N> newEdge = new Edge<>(destinationVertex, w,c, currentEdge);
   ...
   public N getEdgeSpeed(T source, T destination) {
      N notFound=null;
      if (head==null)
         return notFound;
      if (!hasVertex(source) || !hasVertex(destination)) 
